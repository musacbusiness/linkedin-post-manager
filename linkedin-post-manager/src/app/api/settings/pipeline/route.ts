...
export async function GET(_request: NextRequest) {
  try {
    ...
    return NextResponse.json({
      ...
      frameworkAllowed: data.framework_allowed || ['AIDA', 'PAS', 'Story', 'VSQ'],
